...
my %result = get_url("http://$self->{host}:$self->{port}");
...
my %result = get_url("http://$self->{host}:$self->{port}/chdir?p=$self->{password}&dir=$newdir");
...
my %result = get_url("http://$self->{host}:$self->{port}/delete?p=$self->{password}");
return $result{error_message} if ( $result{error_message} );
return $result{page_html};
}
...
my %result = get_url("http://$self->{host}:$self->{port}/deletepos?p=$self->{password}&index=$pos");
return $result{error_message} if ( $result{error_message} );
return $result{page_html};
}
